...
const page = () => {
  ...
  const urlCard = process.env.NEXT_PUBLIC_API_URL
    ? `${process.env.NEXT_PUBLIC_API_URL}/api/auth/getAllUsersInfo/UsersCard`
    : "http://localhost:3000/api/auth/getAllUsersInfo/UsersCard";
  const urlUser = process.env.NEXT_PUBLIC_API_URL
    ? `${process.env.NEXT_PUBLIC_API_URL}/api/auth/getUserById`
    : "http://localhost:3000/api/auth/getUserById";
  const urlTicket = process.env.NEXT_PUBLIC_API_URL
    ? `${process.env.NEXT_PUBLIC_API_URL}/api/auth/getAllUsersInfo/UsersTicket`
