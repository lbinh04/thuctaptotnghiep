  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (typeof window !== "undefined") {
        ...
        message.innerHTML = "✅ Cảm ơn bạn đã thanh toán thành công!";
        message.className =
          "fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg animate-fade-in z-50";
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-blue-100 text-lg animate-fade-in delay-300">
              Email xác nhận đã gửi tới địa chỉ của bạn
            </p>
          </div>
